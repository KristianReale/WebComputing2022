	...
	<head>
		...
		<script>
			window.onload = function(){
				$.get("https://jsonplaceholder.typicode.com/posts/4", "", function(risposta){
					alert(risposta.body);
				});
			};
		...
		<script type="text/javascript" src="https://api.flickr.com/services/feeds/photos_public.gne?format=json&tags=dog"></script>
